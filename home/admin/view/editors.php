      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Top Notch Editors</h3>
          	<div class="row mt">
          		<div class="col-lg-12">
          		<p></p>
                  </div>
                  ...
                  <table class="table table-striped table-advance table-hover">
                    ...
                    if ($results->num_rows >0){
                        ...
                        while($row = $results->fetch_assoc()){
                            ...
                            echo '
                            <tr>
                            <td><a href="#"> '.$row["e_id"].'</a></td>
                             <td><a href="#">'.$row["f_name"].'</a></td>
                             <td><a href="#">'.$row["eu_name"].'</a></td>
                            ...
                            echo'
                             <td class="position-relative">
                                 <a href="approve_ed.php?user='.$row["e_id"].'"><button class="btn btn-success btn-xs">
                                 <i class="fa fa-check">Approve</i></button></a>
                                 <a href="edit_ed.php?user='.$row["e_id"].'"><button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button></a>

                                 ';
                                 ?>
                                 <div class="popup" onclick="myFunction(<?php echo $row["e_id"]; ?>)">
                                 <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o ">Delete</i></button>
                                 <span class="popuptext" id="myPopup<?php echo $row["e_id"]; ?>">
                                 <a href="del_ed.php?user=<?php echo' '.$row["e_id"].' ';?>" class="btn btn-success btn-xs">
