                          ...
                          <div class="content-panel">
                              ...
                              <div class="panel-body text-left">
                                  ...
                                  <?php
                                    ...
                                    $sql = "select r.u_id,u.u_name,o.* from order_prog r join orders o on o.o_id=$_GET[o_id] and r.status=4 join users u on r.u_id=u.u_id";
                                    $res = $conn->query($sql);
                                    echo $conn->error;  
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel" style="padding:4px;">
                              ...
                              <div class="panel-body text-left" style="color:black;background-color:#eee;padding:4px;text-size:12px;width:100%;font-family:sans serif;">
                                ...
                                // $sl= "select re.o_id,o.*,u.u_id from order_prog re join orders o on re.o_id=o.o_id join users u on re.u_id=u.u_id where re.o_id=$_GET[o_id] and status=4";
                  ...
                  <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
                              ...
                              <?php 
                                ...
                                $sl= "select re.o_id,o.*,u.u_id from order_prog re join orders o on re.o_id=o.o_id join users u on re.u_id=u.u_id where re.o_id=$_GET[o_id] ";
                                ...
                                ';
                                  ...
                                  <hr>
                                    <?php 
                                require"../php/conn.php";
                                $sl= "select ed.attached,ed.o_id,o.o_id from order_prog ed join orders o on ed.o_id=o.o_id where ed.o_id=$_GET[o_id] and status=4";
                                $ress= $conn->query($sl);
                                ...
                                <?php 
                                require"../php/conn.php";
                                $sl= "select re.attached,re.o_id,o.o_id from order_prog re join orders o on re.o_id=o.o_id where re.o_id=$_GET[o_id] and rev_status=4";
                                $ress= $conn->query($sl);
                                $row = $ress->fetch_array();

                                
                                echo'
                                <p><a href="..\..\writer/user-attach/'.$row["attached"].'"> '.$row["attached"].' </a></p><p>:[by writer: Revised]</p>
                                ';
                      ...
                      <div class="col-lg-6">
                          ...
                          <h4> Seek Action From:
                             ...
                             <a href="..\view/toedit.php?order_id='.$_GET['o_id'].' && user_id='.$_GET['user'].'"> <button data-dismiss="modal" class="btn btn-warning" type="button">To Editing</button></a>
