    ...
    <script src="../../../js/active.js"></script>
          <section class="wrapper site-min-height">
              ...
              <?php
                 ...
                 $sql = "select e.u_id,o.*,e.e_id,d.e_id from order_prog e join orders o on o.o_id=e.o_id join editors d on d.e_id=e.e_id where e.u_id=$_GET[user] and o.o_id=$_GET[o_id] and d.e_id=$_SESSION[sess_id] and e.status=5 ";
                  ...
                  <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
							  <h4>Order Information <span class="label label-success label-mini" >Closed</span></h4>
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
                              ...
                              <?php 
                                ...
                                <?php 
                                require"../php/conn.php";
                                $srl= "select ed.attach_rev,ed.o_id,o.o_id,u.*,ed.u_id from order_prog ed join orders o on ed.o_id=o.o_id join users u on u.u_id=ed.u_id where ed.o_id=$_GET[o_id] and ed.e_id=$_SESSION[sess_id] and u.u_id=$_GET[user] and ed.rev_status=4";
                                $ress= $conn->query($srl);
                                $row = $ress->fetch_assoc();
