...
?>
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
              ...
              <?php
                 ...
                 $sql = "select e.u_id,o.* from order_prog e join orders o on o.o_id=e.o_id  where e.u_id=$_SESSION[sess_id] and o.o_id=$_GET[o_id] and e.status=3 ";
                 $res = $conn->query($sql);
                    echo $conn->error;  
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
                              ...
                              <?php
                                  ...
                                  ?>
                                  <span class="label label-warning label-mini" >Editing</span></h4>
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
                              ...
                              <?php 
                                ...
                                <?php
                                 require"../php/conn.php";
                                 $srl= "select ed.attached_ed,ed.o_id,o.o_id,ed.e_id from order_prog ed join orders o on ed.o_id=o.o_id where ed.o_id=$_GET[o_id] and ed.u_id=$_SESSION[sess_id] and ed.status=3";
                                 $ress= $conn->query($srl);
                                  ...
                                  ?>
                                        ...
                                        <i>
                                           ...
                                           <?php   require"..\php/conn.php";
                                            ...
                                            $sq="select m.o_id,m.u_id,m.message,m.date_created from messages m join orders o on m.o_id=o.o_id join users u on m.u_id=u.u_id where m.o_id=$_GET[o_id] and m.u_id=$_SESSION[sess_id] ORDER by ms_id asc";
                                            $res= $conn->query($sq);
                                            // $row= $res->fetch_assoc();
 ...
 ?> 
                                        ...
                                        $sq="select m.o_id,m.u_id,m.u_message,m.date_created from messages m join orders o on m.o_id=o.o_id join users u on m.u_id=u.u_id where m.o_id=$_GET[o_id] and m.u_id=$_SESSION[sess_id] ORDER by ms_id asc";
                                        $res= $conn->query($sq);
                                        // $row= $res->fetch_assoc();
                                        while($row= $res->fetch_assoc()){
                                        if($row['u_message'] !=''){
