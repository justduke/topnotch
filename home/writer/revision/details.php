      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i clas="fa"><img src="..\..\assets/img/rev-icon.png" class="img" width="60"></i>Order Details</h3>
              ...
              <?php
                 ...
                 $sql = "select r.u_id,o.* from order_prog r join orders o on o.o_id=r.o_id  where r.u_id=$_SESSION[sess_id] and o.o_id=$_GET[o_id]  and status=4";
                 $res = $conn->query($sql);
                //  $row = $res->num_rows();    
                ...
                //    $msg ='<p class="text-center btn-success">Order assigned</p>';
                  echo $msg;
              ...
              <div class="row mt">
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel" style="padding:4px;">
                              ...
                              <div class="panel-body text-left" style="color:black;background-color:#eee;padding:4px;text-size:12px;width:100%;font-family:sans serif;">
                                ...
                                $sl= "select re.o_id,o.*,u.u_id from order_prog re join orders o on re.o_id=o.o_id join users u on re.u_id=u.u_id where re.o_id=$_GET[o_id] and re.status=4";
                  ...
                  <div class="row mt">
                      <div class="col-lg-6">
                          <div class="content-panel">
                              ...
                              <?php 
                                ...
                                <?php 
                                require"../php/conn.php";
                                $sl= "select ed.attach_rev,ed.o_id,o.o_id from order_prog ed join orders o on ed.o_id=o.o_id where ed.o_id=$_GET[o_id] and ed.rev_status=4";
                                $ress= $conn->query($sl);
                                $row = $ress->fetch_array();
                      ...
                      <div class="col-lg-6">
                          <div class="content-panel">
							  <h4> Upload Revised Draft</h4>
                              <div class="panel-body text-center">
                              <div class="panel-body text-center">
                                  <form action="upldraft.1.php" method="post" enctype="multipart/form-data">
                                  ...
                                  <?php 
                                    ...
                                    // echo'
                                    // <a href="upldraft.php?user='.$_SESSION["sess_id"].'&&o_id='.$_GET['o_id'].'"><input class="btn btn-info" type="submit" required name="submitDraft" value="Complete Order"></a>
