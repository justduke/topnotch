...
<head>
    ...
    <!-- Title -->
    <title>Writer's Club Frelancers</title>
                ...
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="academyNav">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Pages</a>
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="course.php">Terms of Service</a></li>
                        ...
                        <div class="calling-info">
                            ...
                            <a href="tel:+254707133141"><i class="icon-telephone-2"></i> <span>(+254) 707 133 141</span></a>
                            </div>
                        </div>
                    </nav>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="footer-widget mb-100">
                            ...
                            <p>A 24/7 support team is here to ensure productivity and quality of your paper.</p>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Top Notch - Freelancers
